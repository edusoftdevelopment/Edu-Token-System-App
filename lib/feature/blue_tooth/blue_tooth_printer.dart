...
//     await _bluePrintPos.scan().then((List<BlueDevice> devices) {
...
//     });
//     final blueDevice = _blueDevices[index];
...
//     final receiptText = ReceiptSectionText()
//       ..addImage(
...
//       ..addLeftRightText('Time', '04/06/22, 10:30')
//       ..addSpacer(useDashed: true)
//       ..addLeftRightText(
//         'Apple 4pcs',
//         r'$ 10.00',
...
//     /// Text after QR
//     final receiptSecondText = ReceiptSectionText()
//     ..addText(
//       'Powered by Google',
//       size: ReceiptTextSizeType.small,
//     )
